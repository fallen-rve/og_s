...
var foundation = require('foundation').includePaths;
...
gulp.task('postcss', function() {
    ...
    .pipe(sourcemaps.init())
        ...
        .pipe(sass({
            includePaths: [].concat(foundation),
...
gulp.task('wp-pot', function () {
    ...
    .pipe(wpPot({
        ...
        destFile:'og_s.pot',
        package: 'og_s',
        bugReport: 'http://og_s.com',
        lastTranslator: 'John Doe <mail@og_s.com>',
        team: 'Team <mail@og_s.com>'
    }))
